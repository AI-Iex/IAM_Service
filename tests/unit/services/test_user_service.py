...
async def test_create_by_admin_sets_require_password_change():
    ...
    payload = UserCreateByAdmin(email = "admincreate@example.com", full_name = "Admin Create", password = "StrongPass1!", is_active = True, is_superuser = False)
...
async def test_create_user_existing_email_raises():
    ...
    payload = UserCreateByAdmin(email = "dup2@example.com", full_name = "Dup User 2", password = "StrongPass1!", is_active = True, is_superuser = False)
...
async def test_change_email_current_mismatch_raises():
    ...
    payload = UserChangeEmail(current_email = "wrong@example.com", new_email = "new@example.com", current_password = "password")
...
async def test_change_email_new_exists_raises():
    ...
    payload = UserChangeEmail(current_email = "old@example.com", new_email = "new@example.com", current_password = "TestPass1!")
    with pytest.raises(EntityAlreadyExists):
        await svc.change_email(user.id, payload)
...
async def test_change_email_password_mismatch_raises():
    ...
    payload = UserChangeEmail(current_email = "old@example.com", new_email = "new@example.com", current_password = "WrongPass")
    with pytest.raises(DomainError):
        await svc.change_email(user.id, payload)
