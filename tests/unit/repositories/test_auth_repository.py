...
async def test_get_user_for_auth_and_client(db_session):
	...
	# Create user
	dto = UserCreateInDB(email="authrepo_emailcheck@example.com", full_name="authrepo_name", hashed_password=hash_password("pw"), is_active=True, is_superuser=False, require_password_change=False)
