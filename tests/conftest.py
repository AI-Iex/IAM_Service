...
async def async_client(db_session) -> AsyncGenerator[AsyncClient, None]:
	...
	app.dependency_overrides[auth_deps.get_current_principal] = (
		_override_get_current_principal
	)
	app.dependency_overrides[auth_deps.get_current_principal_optional] = (
		_override_get_current_principal_optional
	)
