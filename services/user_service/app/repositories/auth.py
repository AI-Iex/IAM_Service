...
class AuthRepository(IAuthRepository):
    ...
    async def create_refresh_token(self, db: AsyncSession, jti: UUID, user_id: UUID, hashed_token: str, expires_at: datetime, user_agent: Optional[str] = None, client_ip: Optional[str] = None):
