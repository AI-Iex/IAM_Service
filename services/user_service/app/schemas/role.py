...
class RoleCreate(RoleBase):
    permissions: Optional[List[PermissionRef]] = Field(default=None, example = [{"name": "users:read"}], description = "List of permissions assigned to this role")
...
class RoleUpdate(BaseModel):
    ...
    permissions: Optional[List[PermissionRef]] = Field(default = None, example = [{"name": "users:read"}], description = "Updated list of permissions")
...
class RoleRead(RoleBase):
    ...
    permissions: Optional[List[PermissionRead]] = Field(default=[], example=[{"id": "uuid", "name": "users:read", "description": "Allows reading users"}], description="List of permissions assigned to this role")
