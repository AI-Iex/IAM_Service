...
class UserBase(BaseModel):
    email: str = Field(..., example = "user@gmail.com", description = "The user's email address")
...
class UserUpdate(BaseModel):
    ...
    roles: Optional[List[str]] = Field(None, example = ["admin", "developer"], description = "List of roles assigned to the user")


class UserUpdateInDB(BaseModel):
    """Internal schema used by services when passing update payloads to repositories."""
    email: Optional[str] = Field(None, example = "user@gmail.com", description = "The user's email address")
    full_name: Optional[str] = Field(None, example = "Name Surname", description = "The user's name and surname")
...
class UserRead(UserBase):
    ...
    roles: List[RoleReadWithoutPermissions] = Field(default = [], example = ["""admin", "user"""], description = "List of roles assigned to the user")
    require_password_change: bool = Field(default = False, example = False, description = "Flag to force the user change the password")
...
class UserReadDetailed(UserRead):
    roles: List[RoleRead] = Field(default = [], example = ["""admin", "user"""], description = "List of roles assigned to the user")
